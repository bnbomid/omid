...
<div class="wrap">
  <div class="card">
    <div class="brand">
      ...
      <div><div class="brand-name">omid</div><div class="brand-sub">v9.5</div></div>
    </div>
    <h1>ورود به پنل</h1>
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">omid</div><div class="logo-sub">v9.5</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">omid v9.5 · Railway</span>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانی omid</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم omid</div>
      </div>
    </div>
    <div class="srv-tiles">
      <a class="srv-tile" href="omid" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-youtube"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">یوتیوب</div><div class="srv-tile-val">omid</div></div>
      </a>
...
<div class="wrap">
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/Farajian2004f" target="_blank">@Farajian2004f</a> · omid v9.5</div>
</div>
<script>
