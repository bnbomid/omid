...
<div class="modal-bg" id="modal-edit-link">
  <div class="modal">
    ...
    <div class="fg" style="margin-bottom:13px"><label>لوکیشن (برچسب کانفیگ)</label>
      <select class="fs" id="el-loc" style="width:100%">
        <option value="auto">🌐 پیش‌فرض (این سرور)</option>
        <option value="es">🇪🇸 اسپانیا</option>
        <option value="pt">🇵🇹 پرتقال</option>
      </select>
    </div>
