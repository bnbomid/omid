...
## 📍 لوکیشن کانفیگ (اسپانیا / پرتقال)

هنگام ساخت یا ویرایش هر کانفیگ (هم در پنل وب، هم در ربات تلگرام) می‌تونید یک **لوکیشن نمایشی** برای اون انتخاب کنید: پیش‌فرض 🌐، اسپانیا 🇪🇸 یا پرتقال 🇵🇹. این لوکیشن به‌صورت پرچم/برچسب روی کارت کانفیگ، نام لینک VLESS و پیام‌های ربات نمایش داده می‌شه.

⚠️ **نکته مهم:** چون این نسخه یک گیت‌وی تک‌سروریه (روی یک دیپلوی Railway اجرا می‌شه)، انتخاب لوکیشن فقط یک **برچسب نمایشی** برای دسته‌بندی/نام‌گذاری کانفیگ‌هاست و **IP خروجی واقعی ترافیک رو عوض نمی‌کنه** — ترافیک همچنان از همون سروری خارج می‌شه که پنل روش دیپلوی شده. برای این‌که ترافیک واقعاً از اسپانیا یا پرتقال خارج بشه، باید یک نود واقعی (VPS یا سرور پراکسی) در اون کشور داشته باشید و آن را به‌عنوان نود جدا دیپلوی/ریله کنید.
...
omid · پشتیبانی: [@omiddemon](https://t.me/omiddemon)
